...
from descarga_datos import get_email_from_enviormet_variable
...
def test_get_email_from_enviormet_variable():
    obtained_email = get_email_from_enviormet_variable()
